...
public class BackOfficeUserManagementController {
  ...
  public ResponseEntity<Object> getAllUsers(
      @Parameter(description = "Page number (1-based)", example = "1")
          ...
          Integer pageNumber,
      @Parameter(description = "Page size (max 16)", example = "16") @RequestParam(required = false)
          Integer pageSize) {
  ...
  //            @Parameter(description = "Search term to filter users by firstName, lastName, or
  // email", example = "john", required = true)
  ...
  //
  //        return ControllerResponse.buildCreateSuccessResponse(
  //                backOfficeUserProfileService.searchUsersPaginated(search, pageNumber,
  // pageSize));
  //    }
  //
  //    /**
  ...
  //            @Parameter(description = "Filter by profile status (ACTIVE, INACTIVE, LOCKED,
  // DEACTIVATED)", example = "ACTIVE", required = true)
  ...
  //
  //        return ControllerResponse.buildCreateSuccessResponse(
  //                backOfficeUserProfileService.getUsersByStatusPaginated(profileStatus,
  // pageNumber, pageSize));
  //    }
}
