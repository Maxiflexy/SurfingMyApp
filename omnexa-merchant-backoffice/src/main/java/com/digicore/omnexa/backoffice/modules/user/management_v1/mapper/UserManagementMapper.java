 ...
 *
 * <p>Handles validation and transformation of user management request parameters.
...
public class UserManagementMapper {
    ...
    public int[] validatePaginationParameters(Integer pageNumber, Integer pageSize) {
        ...
        if (pageSize != null && (pageSize < 1 || pageSize > 16)) {
            log.warn("Invalid page size provided: {}. Using bounded value: {}", pageSize, validatedPageSize);
        }

        log.debug("Validated pagination parameters: pageNumber={}, pageSize={}",
                validatedPageNumber, validatedPageSize);
