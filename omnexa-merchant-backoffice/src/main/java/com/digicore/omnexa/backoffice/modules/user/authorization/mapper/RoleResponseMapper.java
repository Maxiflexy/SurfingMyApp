 ...
 *
 * <p>This mapper handles the transformation of role entities and related data
 * into appropriate response DTOs using the existing common lib DTOs to maintain
...
public class RoleResponseMapper {
     ...
     */
    public static List<RoleDTO> mapEntitiesToRoleDTOs(List<BackOfficeUserRole> roles) {
        if (roles == null) {
            return null;
        }

        return roles.stream()
                .map(RoleResponseMapper::mapEntityToRoleDTO)
