 ...
 *
 * <p>These tests validate the behavior of the controller's endpoints, ensuring
 * that the correct services and facades are invoked and the expected responses
 * are returned.
 *
 * <p>Author: Onyekachi Ejemba
 * Created On: Jul-23(Wed)-2025
 */
class BackOfficeUserOnboardingControllerTest {

    @Mock
    private FacadeResolver facadeResolver; // Mock for resolving facades

    @Mock
    private BackOfficeUserProfileService backOfficeUserProfileService; // Mock for user profile service
    ...
    @InjectMocks
    private BackOfficeUserOnboardingController controller; // Controller under test
    ...
    /**
     * Tests the inviteBackOfficeUser method to ensure it returns a success response
     * when a valid request is provided.
     */
    @Test
    ...
    /**
     * Tests the retrieveBackOfficeUser method to ensure it returns a user profile
    ...
    /**
     * Tests the completeSignUp method to ensure it returns a success response
     * when a valid signup request is provided.
     */
    @Test
    @SuppressWarnings("unchecked")
