...
import com.digicore.omnexa.common.lib.transaction.enums.TransactionStatus;
 ...
 */
@Converter
public class TransactionStatusConverter extends StringEnumConverter<TransactionStatus> {
