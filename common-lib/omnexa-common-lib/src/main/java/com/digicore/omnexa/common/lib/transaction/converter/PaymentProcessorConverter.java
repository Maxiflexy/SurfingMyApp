...
import com.digicore.omnexa.common.lib.transaction.enums.PaymentProcessor;
 ...
 */
@Converter
public class PaymentProcessorConverter extends StringEnumConverter<PaymentProcessor> {

  /** Default constructor that initializes the `StringEnumConverter` with the `Status` class. */
  public PaymentProcessorConverter() {
    super(PaymentProcessor.class);
  }
}
