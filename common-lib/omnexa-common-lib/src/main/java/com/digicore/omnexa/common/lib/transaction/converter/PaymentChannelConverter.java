...
import com.digicore.omnexa.common.lib.transaction.enums.PaymentChannel;
 ...
 */
@Converter
public class PaymentChannelConverter extends StringEnumConverter<PaymentChannel> {

  /** Default constructor that initializes the `StringEnumConverter` with the `Status` class. */
  public PaymentChannelConverter() {
