...
package com.digicore.omnexa.common.lib.swagger.constant.outlet;
...
public class OutletSwaggerDoc {
  ...
  public static final String OUTLET_CONTROLLER_TITLE = "Merchant-Outlet-Module";
  ...
  /** Summary for the get single outlet API operation. */
  public static final String OUTLET_CONTROLLER_GET_SINGLE = "Get Merchant Profile by profileId";

  /** Description for the single outlet API operation. */
  public static final String OUTLET_CONTROLLER_GET_SINGLE_DESCRIPTION =
      "This API is used to get single merchant outlet profile by profileId.";
}
