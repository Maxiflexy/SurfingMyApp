...
import com.digicore.omnexa.common.lib.transaction.enums.TransactionVerificationStatus;
 ...
 */
@Converter
public class TransactionVerificationStatusConverter
    extends StringEnumConverter<TransactionVerificationStatus> {

  /** Default constructor that initializes the `StringEnumConverter` with the `Status` class. */
  public TransactionVerificationStatusConverter() {
    super(TransactionVerificationStatus.class);
  }
}
