...
import com.digicore.common.lib.api.ControllerResponse;
...
public class OmnexaControllerAdvice {
  ...
  public ResponseEntity<Object> handleFileNotFoundException(
    ...
    apiErrors.add(new ApiError("file not found", "02", request.getDescription(false)));
  ...
  public ResponseEntity<Object> handleValidationException(
    ...
    for (FieldError fieldError : fieldErrors) {
      ApiError error =
          new ApiError(fieldError.getDefaultMessage(), "90", request.getDescription(false));
      errors.add(error);
    }
  ...
  public ResponseEntity<Object> handleFieldExceededException(
    ...
    List<ApiError> apiErrors = new ArrayList<>();
    apiErrors.add(new ApiError(exception.getMessage(), "01", request.getDescription(false)));
    ApiResponseJson<Object> responseJson =
        ApiResponseJson.builder()
            .data(null)
            .errors(apiErrors)
