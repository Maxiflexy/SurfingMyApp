...
import com.digicore.common.lib.enums.KycStatus;
 ...
 */
@Converter
public class KycStatusConverter extends StringEnumConverter<KycStatus> {

  /** Default constructor that initializes the `StringEnumConverter` with the `Status` class. */
  public KycStatusConverter() {
    super(KycStatus.class);
  }
}
