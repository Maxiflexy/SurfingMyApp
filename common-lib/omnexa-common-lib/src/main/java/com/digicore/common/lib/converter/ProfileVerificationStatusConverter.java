 ...
 */
@Converter
public class ProfileVerificationStatusConverter
    extends StringEnumConverter<ProfileVerificationStatus> {

  /** Default constructor that initializes the `StringEnumConverter` with the `Status` class. */
  public ProfileVerificationStatusConverter() {
    super(ProfileVerificationStatus.class);
  }
}
