...
@Configuration
@ComponentScan({"com.digicore.omnexa.merchant.modules"})
@EntityScan({"com.digicore.omnexa.merchant.modules"})
@EnableJpaRepositories(basePackages = {"com.digicore.omnexa.merchant.modules"})
