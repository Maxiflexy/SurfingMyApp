...
package com.digicore.omnexa.merchant.modules.profile.user.dto.response;
...
@NoArgsConstructor
@AllArgsConstructor
public class MerchantUserProfileInfoResponse implements ProfileInfoResponse {

    /** The profile ID of the merchant user. */
    private String profileId;

    /** The full name of the merchant user (firstName + lastName). */
