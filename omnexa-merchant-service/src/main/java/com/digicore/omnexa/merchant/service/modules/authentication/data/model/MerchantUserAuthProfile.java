...
package com.digicore.omnexa.merchant.service.modules.authentication.data.model;
...
public class MerchantUserAuthProfile extends BaseAuthModel implements Serializable {
  ...
  @OneToOne(mappedBy = "merchantUserAuthProfile", cascade = CascadeType.ALL, optional = false)
  private MerchantUserLoginProfile merchantUserLoginProfile;
}
